...
CREATE TABLE EQUIPAMIENTO (
  idEQUIPAMIENTO INTEGER PRIMARY KEY NOT NULL,
  idAMBIENTE INTEGER NOT NULL,
  ...
  FOREIGN KEY(idAMBIENTE)
    REFERENCES AMBIENTE(idAMBIENTE)
      ON DELETE NO ACTION
      ON UPDATE NO ACTION,
  FOREIGN KEY(idTIPOELEMENTO) REFERENCES TIPOELEMENTO(idTIPOELEMENTO) ON DELETE NO ACTION ON UPDATE NO ACTION
);
...
CREATE TABLE "TIPOELEMENTO" (
  "idTIPOELEMENTO" INTEGER PRIMARY KEY NOT NULL,
  "NOMTIPO" TEXT
);
...
SELECT E.IDAMBIENTE,A.NOMBRE AMBIENTE,E.ESTACION,E.NOMBRE TIPO, E.SERIAL, CASE WHEN E.ESTADO=0 THEN 'OK'
WHEN E.ESTADO=1 THEN 'NO FUNCIONAL'
WHEN E.ESTADO=2 THEN 'EN MANTENIMIENTO'
